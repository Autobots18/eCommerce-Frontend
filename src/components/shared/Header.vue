              ...
              <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="nav-link">Shop NOW!<i class="fa fa-angle-down"></i></a>
                <div class="dropdown-menu megamenu">
                  <div class="row">
                    ...
                    <div class="col-lg-3 text-center product-col hidden-lg-down"><a href="detail.html" class="product-image"><img src="/static/img/shirt.png" alt="..." class="img-fluid"></a>
                ...
                <div aria-labelledby="cartdetails" class="dropdown-menu">
                  ...
                  <div class="dropdown-item cart-product">
                    <div class="d-flex align-items-center">
                      <div class="img"><img src="/static/img/hoodie-man-1.png" alt="..." class="img-fluid"></div>
